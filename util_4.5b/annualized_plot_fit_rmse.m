function  [r2a, vname, rmseA] = annualized_plot_fit(pplotvar, q2a, M_, options_, oo_, T, Tlim, nplots, pplottitles, pposterior)
...
for j=1:length(pplotvar),
   ...
   for jfcast = 1:forecast_,
       ...
       rmseA(j,jfcast) = sum((updatedvar(jfcast+1:end-forecast_,j)-squeeze(forecastedvar(jfcast,1:end-forecast_-(jfcast-1),j))').^2) ;
