function out=WriteAnnualShockDecomp2Excel(M_,MatFileList)

if nargin <2,
    MatFileList=[M_.fname,'_AoA_ShockDecomp.mat'];
end
...
for jf=1:length(MatFileList),
    ...
    for jj=1:size(ExistingFields,1)
        ...
        EndTime=InitialTime+LengthOfVar;
        TimeSpan=InitialTime:EndTime;
