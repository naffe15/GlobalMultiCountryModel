...
if exist('NonOil')
    ...
    Tab_Data_tmp = [ TFP; LabGoodMkt; [NaN NaN];[NaN NaN]; Consumption; Investment; Fiscal; Monetary; [NaN NaN]; [NaN NaN] ];
end
...
if ~isempty(exassmptyes)
  ...
  %          Tab_Data_tmp_assmpt = [ TFPassmpt; LabGoodMktassmpt; Oilassmpt;  [NaN]; [NaN ]; Consumptionassmpt; Investmentassmpt; Fiscalassmpt; Monetaryassmpt; [NaN ]; USassmpt; RoWassmpt; Tradeassmpt; FXassmpt; [NaN ]; [NaN] ];
           Tab_Data_tmp_assmpt = [ TFPassmpt; LabGoodMktassmpt; Oilassmpt;  [NaN]; [NaN ]; Consumptionassmpt; Investmentassmpt; Fiscalassmpt; Monetaryassmpt; [NaN ]; [NaN ]; [NaN] ];
