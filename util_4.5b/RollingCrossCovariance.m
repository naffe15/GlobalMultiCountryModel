function out=RollingCrossCovariance(M_, oo_, options_, iplot)
...
eps1 = NaN(length(oo_.SmoothedShocks.(deblank(M_.exo_names(1,:)))(options_.nobs-options_.forecast-options_.RollingWindowSize+1:options_.nobs-options_.forecast))-first_obs+1,M_.exo_nbr);
for j=1:M_.exo_nbr
    tmp = oo_.SmoothedShocks.(deblank(M_.exo_names(j,:)))(options_.nobs-options_.forecast-options_.RollingWindowSize+1:options_.nobs-options_.forecast);
